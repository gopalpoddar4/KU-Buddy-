...
import `in`.gopalpoddar.kubuddy_app.data.local.PreferencesKeys.EMAIL
import `in`.gopalpoddar.kubuddy_app.data.local.PreferencesKeys.NAME
import `in`.gopalpoddar.kubuddy_app.data.local.PreferencesKeys.NOTICE
import `in`.gopalpoddar.kubuddy_app.data.local.PreferencesKeys.NOTICE_TIME
import `in`.gopalpoddar.kubuddy_app.data.local.PreferencesKeys.SEM
import `in`.gopalpoddar.kubuddy_app.data.local.PreferencesKeys.STUDY_MATERIAL_TIME
import `in`.gopalpoddar.kubuddy_app.data.local.PreferencesKeys.UNIVERSITY
